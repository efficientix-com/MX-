                ...
                if (context.type == context.UserEventType.CREATE || context.type == context.UserEventType.EDIT) {
                    ...
                    if (factEspejo != true || (factEspejo == true && tipogbl==2)) {
                        ...
                        for (var i = 0; i < line_count; i++) {
                            ...
                            log.audit({title: 'tipo_articulo', details: tipo_articulo});
                            if (tipo_articulo == 'Discount' || tipo_articulo == 'Group' || tipo_articulo == 'EndGroup' || tipo_articulo == 'Subtotal' || nombre_articulo==articuloajusteTimbrado) {
                                if(nombre_articulo==articuloajusteTimbrado){
                                ...
                                for(var iep=0;iep<config_ieps.length;iep++){
                                    ...
                                    for (var iva = 0; iva < config_iva.length; iva++) {
                                        ...
                                        if (tax_id == config_iva[iva]) {
                                            ...
                                            importeImpuestoCalc = redondeo((((importeConImpuesto - montoLocales) + descuento_sitax) / (rate_div + 1)));
                            ...
                            for (var x = 0; x < tax_lines_count; x++) {
                                            ...
                                            if (i < (line_count - 1)) {
                                                ...
                                                if(tipo_articulo_desc=='Discount'){
                                                    ...
                                                    importeImpuestoCalc = baseIeps+importedescuentoLine;
                                                        ...
                                                        importeImpuestoCalc = redondeo((((importeConImpuesto-montoLocales) + descuento_sitax + montoRetencion) / (rate_div + 1)));
                                                ...
                                                importeImpuestoCalc = redondeo((((importeConImpuesto - montoLocales) + descuento_sitax + montoRetencion) / (rate_div + 1))); //626.137931
                                ...
                                for (var iep = 0; iep < config_ieps.length; iep++) {
                                    ...
                                    if (tax_id == config_ieps[iep]) {
                                        ...
                                        importeImpuestoCalc = importeConImpuesto/(rate_div+1);
                                        importeImpuestoTotalLinea = parseFloat(importeDeImpuesto)-montoIvas-montoLocales;
                        ...
                        var diferenciaTotales = ((parseFloat(obj_Json_Tax_totales.total)+totalcostosenvio - totalTran)+imlocaltotallinea).toFixed(2);
