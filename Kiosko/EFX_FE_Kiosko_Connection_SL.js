...
define(['N/https', 'N/record', 'N/search', 'N/url', 'N/file', 'N/format', 'N/runtime', 'N/config'],
    ...
    function (https, record, search, urlMod, file, format, runtime, config) {
        ...
        function updateInvoiceKioskoInformation(transaction_id, body, razon_social, clienteId) {
            try {
        ...
        function crearXML(tranid, trantype, cliente_k_fact, body_peticion, clienteId) {
            ...
            if (!body_peticion.cliente.regFiscal.text) {
                ...
                if(clienteId){
                    ...
                    updateInvoiceKioskoInformation(tranid, body_peticion, razon_social_to_send, clienteId);
                }
            } else {

                updateInvoiceKioskoInformation(tranid, body_peticion, razon_social_to_send, body_peticion.cliente.id);
            }
