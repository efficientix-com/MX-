...
define(['N/record', 'N/render', 'N/search', 'N/runtime', '../Utilities/libcustomitems', '../Utilities/summary', 'N/file', 'N/xml', 'N/encode', 'N/https', 'N/http', '../Utilities/pagodata', 'N/config', '../Utilities/XmlToPdf', 'N/format', '../Utilities/EFX_FE_Lib', 'N/url'/*,'../EFX_FE_Config_Parameters'*/],
    ...
    function (record, render, search, runtime, customItems, summaryCalc, file, xml, encode, https, http, pagodata, config, XmlToPdf, format, libCFDI, url/*,runtimeObj*/) {
        ...
        function onRequest(context) {
            ...
            if (id_transaccion) {
                ...
                if (!tran_uuid) {
                    ...
                    var result = obtenercustomobject(recordObjrecord, {}, 'invoice', '', '', id_transaccion, '', '', '', nombre_kiosko, rfc_kiosko, codigo_postal_kiosko,regimenFiscal_kiosko);
                    ...
                    var respuesta_return = renderWithValues(customJson, template, recordObjrecord, entityObj, templateobj, id_transaccion, credentials_pac.user_pac, credentials_pac.url_pac, credentials_pac.template_invoice_pac, credentials_pac.tax_id_pac, result, id_cliente_tran, idPropietario, nombre_kiosko, rfc_kiosko, codigo_postal_kiosko,regimenFiscal_kiosko,folderBase);
        ...
        function renderWithValues(customJson, template, recordObjrecord, entityObj, templateobj, id_transaccion, user_pac, url_pac, template_invoice_pac, tax_id_pac, result, id_cliente_tran, idPropietario, nombre_kiosko, rfc_kiosko, codigo_postal_kiosko,regimenFiscal_kiosko,folderBase) {
            try {
