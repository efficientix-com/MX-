    ...
    (record, runtime, search,url,https) => {
        ...
        const getInputData = (inputContext) => {
            try {
                ...
                var idglobal = scriptObj.getParameter({name: 'custscript_efx_fe_elimina_id'});
                log.audit({title: 'idglobal', details: idglobal});
                if(idglobal){
                    var buscaSinUuid = search.create({
                        ...
                        filters: [
                            ...
                            , "AND",                        
                            ["custbody_efx_fe_gbl_related", search.Operator.ANYOF, idglobal]
                        ],
                        columns: [
        ...
        const map = (mapContext) => {
            ...
            try{
                ...
                var tipoTransaccion = '';
                if(datos.values.type.value=='CustInvc'){
                    tipoTransaccion = record.Type.INVOICE;
                }else if(datos.values.type.value=='CashSale'){
                ...
                if(tipoTransaccion){
                    record.submitFields({
                        ...
                        id: datos.values.internalid.value,
                        values: objactualiza
                    });
                }
